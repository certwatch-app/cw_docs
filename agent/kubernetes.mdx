...
<CardGroup cols={3}>
  ...
  <Card title="cw-agent-certmanager" icon="dharmachakra" href="https://artifacthub.io/packages/helm/cw-agent-certmanager/cw-agent-certmanager">
    cert-manager controller
  </Card>
  <Card title="cw-stack" icon="layer-group" href="https://artifacthub.io/packages/helm/cw-stack/cw-stack">
