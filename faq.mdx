...
Yes! CertWatch has a full REST API for programmatic access. Create API keys from the **API Keys** page in your dashboard. API keys support granular scopes (`read`, `write`, `cloud:sync`, or full access) and can be used to integrate CertWatch with your CI/CD pipelines, AWS Lambda functions, or custom tooling. See [API Documentation](/api-reference/introduction) for details.
